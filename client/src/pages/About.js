     ...
     return(
         <>
            ...
            <div className='aboutContainer'>
                <div><img src="https://cdn.worldvectorlogo.com/logos/javascript.svg" className="aboutImg" /></div>
                <div><img src="http://daynin.github.io/clojurescript-presentation/img/react-logo.png" className="aboutImg" /></div>
                <div><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/61/HTML5_logo_and_wordmark.svg/1200px-HTML5_logo_and_wordmark.svg.png" className="aboutImg" /></div>
                <div><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d5/CSS3_logo_and_wordmark.svg/1200px-CSS3_logo_and_wordmark.svg.png" className="aboutImg" /></div>
                <div><img src="https://miro.medium.com/max/2560/1*MuVcoMPyJcq8G4qf5s3HGQ.png" className="aboutImg"/></div>
                <div><img src="https://www.somagnews.com/wp-content/uploads/2020/04/75-e1586981465263.png" className="aboutImg" /></div>
                <div><img src="https://git-scm.com/images/logos/downloads/Git-Logo-2Color.png" className="aboutImg"/></div>
                <div><img src="https://avatars1.githubusercontent.com/u/1160530?s=280&v=4" className="aboutImg"/></div>
                <div><img src="https://bitsrc.imgix.net/3fb49197a90923920dcee2f4f5c36cea2c2a1f73.png" className="aboutImg"/></div>
                <div><img src="https://miro.medium.com/max/6668/1*XP-mZOrIqX7OsFInN2ngRQ.png" className="aboutImg"/></div>
                <div><img src="https://career.guru99.com/wp-content/uploads/2014/07/MySQL.svg_-1280x720.png" className="aboutImg"/></div>
                <div><img src="https://miro.medium.com/max/2800/1*3AdbbRN3GoTbz72XqfO96g.png" className="aboutImg"/></div>
                <div><img src="https://www.timewax.com/wp-content/uploads/2018/10/Slack-RGB.png" className="aboutImg"/></div>
                <div><img src="https://uca.edu/cte/files/2020/07/zoom.png" className="aboutImg"/></div>
        ...
        <Card>
            ...
            <Card.Body>
            <Card.Title className="nameTitle">Scott House</Card.Title>
            <Card.Text>
        ...
        <Card>
            ...
            <Card.Body>
            <Card.Title className="nameTitle">Angela Gutierrez</Card.Title>
            <Card.Text>
        ...
        <Card>
            ...
            <Card.Body>
            <Card.Title className="nameTitle">Shannon Trainor</Card.Title>
            <Card.Text>
        ...
        <Card>
            ...
            <Card.Body>
            <Card.Title className="nameTitle">Diana Zsigray</Card.Title>
            <Card.Text>
