      ...
      <Container className="inspages">
        <Row style={{ display: "inline" }}>
          ...
          />;
            ...
            <p>Buying a house is one of the biggest, if not the biggest investment you make in your life. That's why you need to protect the home you choose.</p>
          ...
          <p>Additionally, homeowner's insurance provides financial protection against disasters. A standard home insurance policy insures the home itself along with the items kept inside.</p>
